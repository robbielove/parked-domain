            ...
            <div class="mt-5 mb-5 p-5 bg-black/20 overflow-hidden shadow sm:rounded-lg">
                ...
                <form action="/contact" method="POST" class="mt-6">
                    ...
                    <div class="flex flex-col mt-4">
                        ...
                        <textarea name="message" id="message" cols="30" rows="3" class="mt-1 p-2 rounded-lg border border-gray-300"></textarea>
                    </div>

                    <div class="flex justify-end mt-4">
                        <button type="submit" class="p-2 rounded-lg bg-violet-900 text-white">Submit</button>
                    </div>
                </form>
            </div>
